...
class FastMriDataModule(pl.LightningDataModule):
    ...
    def _create_data_loader(
        ...
        # added the below 12 lines mimicing train to attempt to get val data loader working!
        ...
        if is_train and self.combine_train_val:
            ...
            print(f"dataset: {dataset}, root {data_path}, sample_rate {sample_rate}, volume_sample_rate {volume_sample_rate} ")
            # for val:
            ...
            # Manually setting sample_rate = None above - DOES NOT EFFECT ERROR!
    ...
    def val_dataloader(self):
        ...
        # )
        return self._create_data_loader(
            self.train_transform, data_partition="val", sample_rate=1.0
        )   
