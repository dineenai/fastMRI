...
def cli_main(args):
    ...
    data_module = FastMriDataModule(
        ...
        batch_size=1,
        # num_workers=args.num_workers, #default is 4
        # num_workers=1, #had previousle degreased to 1
        # num_workers=12, #Try increasing 
        num_workers=1, #Try  
        # num_workers=0, #Try ] 
    ...
    print("Num workers, Batch size, accelerator:")
    # args.num_workers=12
    args.num_workers=1
    # args.num_workers=0
    print(args.num_workers) #4
    print(args.batch_size) #1
    print(args.accelerator) #dpd

    # Num_workers = 0 does what?????
...
def build_args():
    ...
    # path_config = pathlib.Path("/data/motion-dnns/fastMRI/fastmri_dirs.yaml")
    num_gpus = 2
    backend = "ddp"
